        ...
        <div className="fixed bottom-2 right-2 z-50">
          <div className="bg-white rounded-md shadow-lg p-2 max-w-md text-center relative">
            <div className="flex gap-3 justify-center items-center mb-3">
              ...
              <div className="border-x-2 animate-boredr-spin border-x-pink-600 rounded-full  flex items-center justify-center h-20 w-20 "> 
                ...
                <div className="border-8 border-gray-600/10 rounded-full flex items-center justify-center">
                  ...
                  <img
                    ...
                    alt="Logo"
                    className="w-14 h-14 rounded-full border-6 border-gray-800"
                  />
                </div>
              </div>
              ...
              <div className="flex-1">
                ...
                {/* Custom message */}
                <p className={`${customColor} font-semibold text-gray-600 mb-6`}>{message}</p>
              </div>
            </div>

            {/* Progress bar */}
            <div className="absolute bottom-0 left-0 w-full h-1 shadow-md bg-white">
              <div
