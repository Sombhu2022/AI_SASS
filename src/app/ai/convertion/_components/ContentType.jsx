...
function ContentType({ contentData }) {
  ...
  return (
    <Link href={`/ai/convertion/${contentData?.link}`} className="block max-w-[250px] md:max-w-[400px] ">
      <div className="border border-gray-600 shadow-md rounded-lg p-6 hover:shadow-xl transition-shadow duration-300 ease-in-out">
